...
struct cpufreq_interactive_tunables {
	...
	/* The upper limit of the scaling-frequency; default to policy->max */
...
static void cpufreq_interactive_timer(unsigned long data)
{
	...
	tunables->boosted = tunables->boost_val || ktime_now < tunables->boostpulse_endtime;
...
static ssize_t show_boostpulse(struct cpufreq_interactive_tunables
		*tunables, char *buf)
{
